        ...
        <div className=" w-full h-full grid grid-cols-[auto_1fr]">
            <div className=" bg-emerald-100 w-18 h-full rounded-tr-2xl rounded-br-2xl py-5 flex flex-col justify-between">
                <div className="grid gap-4">
                    ...
                    <div onClick={()=>setOpenSearchUser(true)} className="w-18 h-12 mx-auto flex justify-center items-center cursor-pointer hover:bg-emerald-300 hover:rounded-4xl hover:text-white" title="Add Friend">
                        <FaUserPlus size={25} />
                    </div>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className=" cursor-pointer" title="User Profile" onClick={() => setEditUserOpen(true)}>
                        <Avatar
                            width={50}
                            height={50}
                            name={user.name}
